<template>
    <div>
        ...
        <div>
            <div class="w-2/3 m-auto text-left my-12">
                <div class="text-darkBlueText text-xl font-bold mb-4"> We take privacy and the protection of your Personal Data seriously.</div>
                <p class="text-lg">
